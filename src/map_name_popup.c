...
static const u8 sRegionMapSectionId_To_PopUpThemeIdMapping[] =
{
    ...
    [MAPSEC_LITTLE_CUP - KANTO_MAPSEC_COUNT ] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_GROWING_PAINS - KANTO_MAPSEC_COUNT ] = MAPPOPUP_THEME_UNDERWATER,
    [MAPSEC_TEENAGE_DAYDREAM - KANTO_MAPSEC_COUNT ] = MAPPOPUP_THEME_STONE,
    [MAPSEC_PRIME - KANTO_MAPSEC_COUNT ] = MAPPOPUP_THEME_STONE2,
    //brick
    //marble
};
