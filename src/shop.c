...
static const struct itemFlagMap itemToFlag[] =
{
    ...
    {ITEM_TOXIC_ORB, FLAG_ROOM_5_CLEAR},
    ...
    {ITEM_BRIGHT_POWDER, FLAG_ROOM_7_CLEAR},
    {ITEM_QUICK_CLAW, FLAG_ROOM_7_CLEAR},
    ...
    {ITEM_EVIOLITE, FLAG_ROOM_9_CLEAR},
...
static const struct itemFlagMap tmToFlag[] =
{
    ...
    // Room 2
    {ITEM_TM67_RECYCLE, FLAG_ROOM_1_CLEAR},
    ...
    {ITEM_TM90_SUBSTITUTE, FLAG_ROOM_3_CLEAR},

    // Room 5 
    {ITEM_TM09_BULLET_SEED, FLAG_ROOM_4_CLEAR},
    {ITEM_TM39_ROCK_TOMB, FLAG_ROOM_4_CLEAR},
    {ITEM_TM83_FLAME_CHARGE, FLAG_ROOM_4_CLEAR},
    {ITEM_TM57_CHARGE_BEAM, FLAG_ROOM_4_CLEAR},

    // Room 6
    {ITEM_TM88_LOW_SWEEP, FLAG_ROOM_5_CLEAR},
    {ITEM_TM78_BULLDOZE, FLAG_ROOM_5_CLEAR},
    {ITEM_TM47_STEEL_WING, FLAG_ROOM_5_CLEAR},
    {ITEM_TM76_STEALTH_ROCK, FLAG_ROOM_5_CLEAR},

    // Room 7
    {ITEM_TM07_HAIL, FLAG_ROOM_6_CLEAR},
    {ITEM_TM11_SUNNY_DAY, FLAG_ROOM_6_CLEAR},
    {ITEM_TM18_RAIN_DANCE, FLAG_ROOM_6_CLEAR},
    {ITEM_TM37_SANDSTORM, FLAG_ROOM_6_CLEAR},

    // Room 8
    {ITEM_TM61_WILL_O_WISP, FLAG_ROOM_7_CLEAR},
    {ITEM_TM96_SHEER_COLD, FLAG_ROOM_7_CLEAR},
    {ITEM_TM73_THUNDER_WAVE, FLAG_ROOM_7_CLEAR},
    {ITEM_TM06_TOXIC, FLAG_ROOM_7_CLEAR},
    {ITEM_TM95_SNARL, FLAG_ROOM_7_CLEAR},
    {ITEM_TM82_BREAKING_SWIPE, FLAG_ROOM_7_CLEAR},

    // Room 9
    {ITEM_TM89_U_TURN, FLAG_ROOM_8_CLEAR},
    {ITEM_TM40_AERIAL_ACE, FLAG_ROOM_8_CLEAR},
    {ITEM_TM72_VOLT_SWITCH, FLAG_ROOM_8_CLEAR},

    // Room 10
    {ITEM_TM56_LEECH_LIFE, FLAG_ROOM_9_CLEAR},
    {ITEM_TM19_GIGA_DRAIN, FLAG_ROOM_9_CLEAR},
    {ITEM_TM54_PSYSHOCK, FLAG_ROOM_9_CLEAR},
    {ITEM_TM42_FACADE, FLAG_ROOM_9_CLEAR},
    {ITEM_TM43_SECRET_POWER, FLAG_ROOM_9_CLEAR},
    ...
    {ITEM_TM97_DARK_PULSE, FLAG_ROOM_13_CLEAR},
    ...
    // Room 16
    {ITEM_TM84_POISON_JAB, FLAG_ROOM_15_CLEAR},
    {ITEM_TM91_FLASH_CANNON, FLAG_ROOM_15_CLEAR},
    {ITEM_TM94_SUCKER_PUNCH, FLAG_ROOM_15_CLEAR},

    // Room 17
    {ITEM_TM99_DAZZLING_GLEAM, FLAG_ROOM_16_CLEAR},
    {ITEM_TM29_PSYCHIC, FLAG_ROOM_16_CLEAR},
    {ITEM_TM30_SHADOW_BALL, FLAG_ROOM_16_CLEAR},

    // Room 18
    {ITEM_TM68_GIGA_IMPACT, FLAG_ROOM_17_CLEAR},
    {ITEM_TM15_HYPER_BEAM, FLAG_ROOM_17_CLEAR},
    {ITEM_TM75_SWORDS_DANCE, FLAG_ROOM_17_CLEAR},

    // Room 19
    {ITEM_TM26_EARTHQUAKE, FLAG_ROOM_18_CLEAR},
    {ITEM_TM36_SLUDGE_BOMB, FLAG_ROOM_18_CLEAR},
    {ITEM_TM01_FOCUS_PUNCH, FLAG_ROOM_18_CLEAR},
    {ITEM_TM53_ENERGY_BALL, FLAG_ROOM_18_CLEAR},

    // Room 20
    {ITEM_TM70_AURORA_VEIL, FLAG_ROOM_19_CLEAR},
    {ITEM_TM71_STONE_EDGE, FLAG_ROOM_19_CLEAR},
    {ITEM_TM77_STRUGGLE_BUG, FLAG_ROOM_19_CLEAR},
...
{
    shopTMslist = Alloc(sizeof(u16) * ARRAY_COUNT(tmToFlag));
    sMartInfo.itemCount = 0;;
    ...
    sMartInfo.itemList = shopTMslist;
}
...
{
    FadeInFromBlack();
    CreateTask(Task_HandleShopMenuQuit, 8);
}
            ...
            else
            {
                if (sMartInfo.martType == MART_TYPE_NORMAL)
                {
                    ...
                    if (ItemId_GetPocket(itemId) == POCKET_TM_HM)
                    {
                        ...
                        tItemCount = 1;
                        sShopData->totalCost = ItemId_GetPrice(tItemId);
