...
static const struct pokeToFlagMap scrollMultiPokeShop[] = 
{
    ...
    //test
    //{SPECIES_EEVEE, 1, FLAG_ALL_STARTERS},
    ...
    {SPECIES_SANDSHREW, 1, FLAG_ROOM_1_CLEAR}, // unbal
    {SPECIES_DROWZEE, 1, FLAG_ROOM_1_CLEAR}, // unbal
    {SPECIES_VULPIX_ALOLAN, 1, FLAG_ROOM_1_CLEAR}, // unbal
    {SPECIES_VULPIX_ALOLAN, 1, FLAG_ROOM_1_CLEAR}, // unbal
    ...
    {SPECIES_MAREEP, 1, FLAG_ROOM_1_CLEAR}, // unbal
    {SPECIES_EKANS, 1, FLAG_ROOM_2_CLEAR},
    {SPECIES_STARLY, 1, FLAG_ROOM_2_CLEAR},
    {SPECIES_TOGEPI, 1, FLAG_ROOM_2_CLEAR},
    {SPECIES_HOUNDOUR, 1, FLAG_ROOM_2_CLEAR}, // unbal
    {SPECIES_VANILLITE, 1, FLAG_ROOM_2_CLEAR}, // unbal
    {SPECIES_YAMASK, 1, FLAG_ROOM_2_CLEAR}, // unbal
    ...
    {SPECIES_DRIFLOON, 1, FLAG_ROOM_3_CLEAR}, // unbal
    {SPECIES_VOLTORB, 1, FLAG_ROOM_3_CLEAR}, // unbal
    {SPECIES_FRILLISH, 1, FLAG_ROOM_3_CLEAR}, // unbal
    {SPECIES_SLOWPOKE, 1, FLAG_ROOM_3_CLEAR}, // unbal
    ...
    {SPECIES_FLABEBE, 1, FLAG_ROOM_4_CLEAR},    // from here down unbalanced
    ...
    {SPECIES_MANTYKE, 1, FLAG_ROOM_6_CLEAR},
    {SPECIES_KOFFING, 1, FLAG_ROOM_6_CLEAR},
    {SPECIES_MAWILE, 3, FLAG_ROOM_6_CLEAR},
    {SPECIES_SABLEYE, 3, FLAG_ROOM_6_CLEAR},
    
    // Growing Pains 3
    {SPECIES_KRICKETUNE, 2, FLAG_ROOM_7_CLEAR},
    {SPECIES_LICKITUNG, 1, FLAG_ROOM_7_CLEAR},
    {SPECIES_LEDIAN, 2, FLAG_ROOM_7_CLEAR},
    {SPECIES_LOMBRE, 2, FLAG_ROOM_7_CLEAR},
    {SPECIES_MURKROW, 2, FLAG_ROOM_7_CLEAR},
    ...
    {SPECIES_VIVILLON, 3, FLAG_ROOM_8_CLEAR},

    // Growing Pains 5
    {SPECIES_ARIADOS, 2, FLAG_ROOM_9_CLEAR},
    {SPECIES_PARASECT, 2, FLAG_ROOM_9_CLEAR},
    {SPECIES_PONYTA_GALARIAN, 1, FLAG_ROOM_9_CLEAR},
    {SPECIES_LINOONE_GALARIAN, 2, FLAG_ROOM_9_CLEAR},
    {SPECIES_SNEASEL, 3, FLAG_ROOM_9_CLEAR},
    {SPECIES_GLIGAR, 3, FLAG_ROOM_9_CLEAR},
    {SPECIES_MEDICHAM, 2, FLAG_ROOM_9_CLEAR},
    {SPECIES_LAMPENT, 2, FLAG_ROOM_9_CLEAR},
