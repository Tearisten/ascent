...
static const struct pokeToFlagMap scrollMultiPokeShopTD[] = 
{
    ...
    {SPECIES_FROSLASS, 3, FLAG_ROOM_10_CLEAR},
    ...
    {SPECIES_WEEZING, 4, FLAG_ROOM_12_CLEAR},
    ...
    {SPECIES_DARMANITAN, 6, FLAG_ROOM_13_CLEAR},
    {SPECIES_DUSKULL, 7, FLAG_ROOM_13_CLEAR},
    {SPECIES_RAICHU_ALOLAN, 5, FLAG_ROOM_13_CLEAR},
    {SPECIES_MALAMAR, 5, FLAG_ROOM_13_CLEAR},
