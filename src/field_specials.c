...
static const struct pokeToFlagMap scrollMultiPokeShopLC[] = 
{
    ...
    {SPECIES_ZUBAT, 1, FLAG_ROOM_1_CLEAR},
    {SPECIES_MARILL, 1, FLAG_ROOM_1_CLEAR},
    {SPECIES_IMPIDIMP, 1, FLAG_ROOM_1_CLEAR},
    ...
    // Little cup 5
    {SPECIES_PINECO, 1, FLAG_ROOM_4_CLEAR},
    {SPECIES_CLEFAIRY, 1, FLAG_ROOM_4_CLEAR},
    {SPECIES_GOLDEEN, 1, FLAG_ROOM_4_CLEAR},
    {SPECIES_FLABEBE, 1, FLAG_ROOM_4_CLEAR}, 
    {SPECIES_SCRAGGY, 1, FLAG_ROOM_4_CLEAR},
    {SPECIES_KRABBY, 1, FLAG_ROOM_4_CLEAR}, 
...
static const struct pokeToFlagMap scrollMultiPokeShopGP[] = 
{
    ...
    {SPECIES_BUIZEL, 1, FLAG_ROOM_5_CLEAR},
    {SPECIES_BERGMITE, 1, FLAG_ROOM_5_CLEAR},
    {SPECIES_SALANDIT, 1, FLAG_ROOM_5_CLEAR},

    // Growing Pains 2
    {SPECIES_LOUDRED, 2, FLAG_ROOM_6_CLEAR},
    {SPECIES_CHINCHOU, 2, FLAG_ROOM_6_CLEAR},
    {SPECIES_BUNEARY, 1, FLAG_ROOM_6_CLEAR},
    {SPECIES_KOFFING, 1, FLAG_ROOM_6_CLEAR},
    {SPECIES_MACHOKE, 2, FLAG_ROOM_6_CLEAR},
    {SPECIES_SEALEO, 2, FLAG_ROOM_6_CLEAR},
    ...
    // Growing Pains 4
    {SPECIES_BUTTERFREE, 3, FLAG_ROOM_8_CLEAR},
    {SPECIES_BEEDRILL, 3, FLAG_ROOM_8_CLEAR},
    {SPECIES_LEDIAN, 2, FLAG_ROOM_8_CLEAR},
    {SPECIES_BEAUTIFLY, 3, FLAG_ROOM_8_CLEAR},
    {SPECIES_DUSTOX, 3, FLAG_ROOM_8_CLEAR},
    {SPECIES_KRICKETUNE, 3, FLAG_ROOM_8_CLEAR},

    // Growing Pains 5
    {SPECIES_ARIADOS, 2, FLAG_ROOM_9_CLEAR},
    {SPECIES_PARASECT, 2, FLAG_ROOM_9_CLEAR},
...
{
    // Teenage Daydream 1
    // give terrain setter or weather setter
    {SPECIES_GIRAFARIG, 4, FLAG_ROOM_10_CLEAR},
    {SPECIES_EMOLGA, 4, FLAG_ROOM_10_CLEAR},
    {SPECIES_GRANBULL, 4, FLAG_ROOM_10_CLEAR},
    {SPECIES_TROPIUS, 4, FLAG_ROOM_10_CLEAR},
    {SPECIES_ABOMASNOW, 3, FLAG_ROOM_10_CLEAR},
    {SPECIES_TORKOAL, 3, FLAG_ROOM_10_CLEAR},
    {SPECIES_DEWGONG, 3, FLAG_ROOM_10_CLEAR},
    {SPECIES_PALOSSAND, 3, FLAG_ROOM_10_CLEAR},

    // Teenage Daydream 2
    {SPECIES_HITMONCHAN, 4, FLAG_ROOM_11_CLEAR},
    {SPECIES_HITMONLEE, 4, FLAG_ROOM_11_CLEAR},
    {SPECIES_HITMONTOP, 4, FLAG_ROOM_11_CLEAR},
    {SPECIES_MAGCARGO, 3, FLAG_ROOM_11_CLEAR},
    {SPECIES_FEAROW, 3, FLAG_ROOM_11_CLEAR},
    {SPECIES_WHISCASH, 4, FLAG_ROOM_11_CLEAR},
    {SPECIES_KLEFKI, 4, FLAG_ROOM_11_CLEAR},

    // Teenage Daydream 3
    {SPECIES_CRAWDAUNT, 4, FLAG_ROOM_12_CLEAR},
    {SPECIES_GALVANTULA, 5, FLAG_ROOM_12_CLEAR},
    {SPECIES_VESPIQUEN, 4, FLAG_ROOM_12_CLEAR},
    {SPECIES_KANGASKHAN, 3, FLAG_ROOM_12_CLEAR},
    ...
    {SPECIES_RAICHU, 5, FLAG_ROOM_13_CLEAR},
    {SPECIES_RAICHU_ALOLAN, 5, FLAG_ROOM_13_CLEAR},
    {SPECIES_REUNICLUS, 6, FLAG_ROOM_13_CLEAR},    
    {SPECIES_SLOWBRO, 5, FLAG_ROOM_13_CLEAR},
    {SPECIES_SLOWKING, 5, FLAG_ROOM_13_CLEAR},
    {SPECIES_PIDGEOT, 5, FLAG_ROOM_13_CLEAR},
    {SPECIES_TAUROS, 6, FLAG_ROOM_13_CLEAR},
    
    // Teenage Daydream 5
    {SPECIES_RHYDON, 6, FLAG_ROOM_14_CLEAR},
    {SPECIES_SCOLIPEDE, 5, FLAG_ROOM_14_CLEAR},
    {SPECIES_BISHARP, 6, FLAG_ROOM_14_CLEAR},
    {SPECIES_SKARMORY, 8, FLAG_ROOM_14_CLEAR},
    {SPECIES_MISMAGIUS, 5, FLAG_ROOM_14_CLEAR},
    {SPECIES_ACCELGOR, 6, FLAG_ROOM_14_CLEAR},
    {SPECIES_GOLDUCK, 5, FLAG_ROOM_14_CLEAR},
    {SPECIES_BELLOSSOM, 6, FLAG_ROOM_14_CLEAR},
    {SPECIES_GLOOM, 6, FLAG_ROOM_14_CLEAR},
...
{   
    ...
    // Prime 2
    {SPECIES_BRONZONG, 7, FLAG_ROOM_16_CLEAR},
    {SPECIES_DRAPION, 6, FLAG_ROOM_16_CLEAR},
    {SPECIES_AGGRON, 6, FLAG_ROOM_16_CLEAR},
    {SPECIES_WEAVILE, 7, FLAG_ROOM_16_CLEAR},
    {SPECIES_GENGAR, 7, FLAG_ROOM_16_CLEAR},
    {SPECIES_GARDEVOIR, 8, FLAG_ROOM_16_CLEAR},
    {SPECIES_GALLADE, 8, FLAG_ROOM_16_CLEAR},
