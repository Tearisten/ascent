...
static const u8 sText_PkmnMakesDragonMiss[] = _("{B_DEF_NAME_WITH_PREFIX} is immune to DRAGON type\nmoves due to {B_DEF_ABILITY}!");
static const u8 sText_PkmnMakesFairyMiss[] = _("{B_DEF_NAME_WITH_PREFIX} is immune to Fairy type\nmoves due to {B_DEF_ABILITY}!");
...
static const u8 sText_SleepClause[] = _("{B_DEF_NAME_WITH_PREFIX} is protected\nby sleep clause!");
...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    ...
    [STRINGID_PKMNHURTBYFREEZE - 12] = sText_PkmnHurtByFreeze,
    [STRINGID_PKMNWASFROZEN - 12] = sText_PkmnWasFrozen,
    [STRINGID_PKMNFROZENBY - 12] = sText_PkmnFrozenBy,
    [STRINGID_PKMNALREADYHASFREEZE - 12] = sText_PkmnAlreadyFroze,
    ...
    [STRINGID_SLEEPCLAUSE - 12] = sText_SleepClause,
    ...
    [STRINGID_PKMNMAKESDRAGONMISS - 12] = sText_PkmnMakesDragonMiss,
    [STRINGID_PKMNMAKESFAIRYMISS - 12] =sText_PkmnMakesFairyMiss,
...
const u16 gMissStringIds[] =
{
    ...
    [B_MSG_DRAGON_MISS] = STRINGID_PKMNMAKESDRAGONMISS,
...
const u8 gText_BattleMenu[] = _("FIGHT{CLEAR_TO 56}PEEK\nPOKéMON{CLEAR_TO 56}GIVE UP");
