...
static void ItemPrintFunc_PossibleGroupMembers(u8 windowId, s32 itemId, u8 y, u8 itemPos);
static void ListMenuItemPrintFunc_UnionRoomGroups(u8 windowId, s32 itemId, u8 y, u8 itemPos);
static void TradeBoardListMenuItemPrintFunc(u8 windowId, s32 itemId, u8 y, u8 itemPos);
static void ItemPrintFunc_EmptyList(u8 windowId, s32 itemId, u8 y, u8 itemPos);
...
void ItemPrintFunc_EmptyList(u8 windowId, s32 itemId, u8 y, u8 itemPos)
{
}
