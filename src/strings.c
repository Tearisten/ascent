...
const u8 gText_ItemsPocket[] = _("HOLD ITEMS");
const u8 gText_PokeBallsPocket[] = _("USE ITEMS");
...
const u8 gText_NumberItem_TMHM[] = _("{STR_VAR_1}.{CLEAR 0x05}{STR_VAR_2}");
...
const u8 gText_EnemyPreview[] = _("Enemy party preview.");
...
const u8 gText_Knockouts[] = _("KO's");
const u8 gText_Faints[] = _("FAINTS");
const u8 gText_Switches[] = _("SWITCHES");
const u8 gText_Battles[] = _("BATTLES");
const u8 gText_Misses[] = _("MISSES");
const u8 gText_Crits[] = _("CRITS");
...
const u8 gText_BattleFrontier[] = _("STARTER ROOM");
...
const u8 gText_MoveRelearnerPkmnTryingToLearnMove[] = _("Should {STR_VAR_1} learn\n{STR_VAR_2}?\p");
