...
static const u8 sLimberDescription[] = _("No pz. Resists Flying type.");
static const u8 sSandVeilDescription[] = _("Slight HP recovery in sand");
...
static const u8 sImmunityDescription[] = _("No psn. Resist psn type.");
...
static const u8 sIlluminateDescription[] = _("Resist Dark/Ghost.");
...
static const u8 sMagmaArmorDescription[] = _("Resist Rock/Ground");
static const u8 sWaterVeilDescription[] = _("No burn. Resist Fighting type.");
...
static const u8 sOvergrowDescription[] = _("Ups Grass moves always.");
static const u8 sBlazeDescription[] = _("Ups Fire moves always.");
static const u8 sTorrentDescription[] = _("Ups Water moves always.");
static const u8 sSwarmDescription[] = _("Ups Bug moves always.");
...
static const u8 sDrySkinDescription[] = _("Prefers moisture and heat.");
...
static const u8 sSpunkyDescription[] = _("Ups Sp. Atk if suffering.");
static const u8 sHarvestDescription[] = _("May recycle a used Berry.");
static const u8 sTelepathyDescription[] = _("Prevents ally damage.");
...
static const u8 sAromaVeilDescription[] = _("No limits on move CHOICE.");
...
static const u8 sBatteryDescription[] = _("Powers up ally special moves.");
...
static const u8 sPowerSpotDescription[] = _("Powers up ally physical moves.");
...
static const u8 sOppressionDescription[] = _("Lowers the foe's Sp. Atk.");
...
static const u8 sRunningRiotDescription[] = _("Ignores recharge on KO.");
...
const u8 gAbilityNames[ABILITIES_COUNT][ABILITY_NAME_LENGTH + 1] =
{
    ...
    [ABILITY_OPPRESSION] = _("Oppression"),
...
const u8 *const gAbilityDescriptionPointers[ABILITIES_COUNT] =
{
    ...
    [ABILITY_SPUNKY] = sSpunkyDescription,
    ...
    [ABILITY_OPPRESSION] = sOppressionDescription,
    ...
    [ABILITY_RUNNING_RIOT] = sRunningRiotDescription,
