...
static const u8 sLimberDescription[] = _("No pz. Resist Flying");
...
static const u8 sImmunityDescription[] = _("No psn. Resist psn.");
...
static const u8 sWaterVeilDescription[] = _("No burn. Resist Fghting.");
