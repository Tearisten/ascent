...
{
    [SPECIES_BULBASAUR]             = {{EVO_ITEM, ITEM_MID_EVO_STONE, SPECIES_IVYSAUR}},
    [SPECIES_IVYSAUR]               = {{EVO_ITEM, ITEM_3SF_EVO_STONE, SPECIES_VENUSAUR}},
    [SPECIES_VENUSAUR]              = {{EVO_MEGA_EVOLUTION, ITEM_VENUSAURITE, SPECIES_VENUSAUR_MEGA}},
    [SPECIES_CHARMANDER]            = {{EVO_ITEM, ITEM_MID_EVO_STONE, SPECIES_CHARMELEON}},
    [SPECIES_CHARMELEON]            = {{EVO_ITEM, ITEM_3SF_EVO_STONE, SPECIES_CHARIZARD}},
    ...
    [SPECIES_SQUIRTLE]              = {{EVO_ITEM, ITEM_MID_EVO_STONE, SPECIES_WARTORTLE}},
    [SPECIES_WARTORTLE]             = {{EVO_ITEM, ITEM_3SF_EVO_STONE, SPECIES_BLASTOISE}},
    ...
    [SPECIES_EKANS]                 = {{EVO_ITEM, ITEM_2SF_EVO_STONE, SPECIES_ARBOK}},
    [SPECIES_PIKACHU]               = {{EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_RAICHU},
                                       {EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_RAICHU_ALOLAN}},
    [SPECIES_SANDSHREW]             = {{EVO_ITEM, ITEM_2SF_EVO_STONE, SPECIES_SANDSLASH}},
    ...
    [SPECIES_CLEFAIRY]              = {{EVO_ITEM, ITEM_3SF_EVO_STONE, SPECIES_CLEFABLE}},
    [SPECIES_VULPIX]                = {{EVO_ITEM, ITEM_FIRE_STONE, SPECIES_NINETALES}},
    [SPECIES_JIGGLYPUFF]            = {{EVO_ITEM, ITEM_3SF_EVO_STONE, SPECIES_WIGGLYTUFF}},
    [SPECIES_ZUBAT]                 = {{EVO_ITEM, ITEM_MID_EVO_STONE, SPECIES_GOLBAT}},
    [SPECIES_GOLBAT]                = {{EVO_ITEM, ITEM_3SF_EVO_STONE, SPECIES_CROBAT}},
    ...
    [SPECIES_DIGLETT]               = {{EVO_ITEM, ITEM_2SF_EVO_STONE, SPECIES_DUGTRIO}},
    [SPECIES_MEOWTH]                = {{EVO_LEVEL, 28, SPECIES_PERSIAN}},
    [SPECIES_PSYDUCK]               = {{EVO_LEVEL, 33, SPECIES_GOLDUCK}},
    [SPECIES_MANKEY]                = {{EVO_ITEM, ITEM_2SF_EVO_STONE, SPECIES_PRIMEAPE}},
    ...
    [SPECIES_ABRA]                  = {{EVO_ITEM, ITEM_MID_EVO_STONE, SPECIES_KADABRA}},
    ...
    [SPECIES_DROWZEE]               = {{EVO_ITEM, ITEM_2SF_EVO_STONE, SPECIES_HYPNO}},
    [SPECIES_KRABBY]                = {{EVO_ITEM, ITEM_2SF_EVO_STONE, SPECIES_KINGLER}},
    [SPECIES_VOLTORB]               = {{EVO_ITEM, ITEM_2SF_EVO_STONE, SPECIES_ELECTRODE}},
    ...
    [SPECIES_KOFFING]               = {{EVO_ITEM, ITEM_2SF_EVO_STONE, SPECIES_WEEZING}},
    ...
    [SPECIES_GOLDEEN]               = {{EVO_ITEM, ITEM_2SF_EVO_STONE, SPECIES_SEAKING}},
    [SPECIES_STARYU]                = {{EVO_ITEM, ITEM_WATER_STONE, SPECIES_STARMIE}},
    [SPECIES_SCYTHER]               = {{EVO_ITEM, ITEM_MID_EVO_STONE, SPECIES_SCIZOR}},
    ...
    [SPECIES_CHIKORITA]             = {{EVO_ITEM, ITEM_MID_EVO_STONE, SPECIES_BAYLEEF}},
    [SPECIES_BAYLEEF]               = {{EVO_ITEM, ITEM_3SF_EVO_STONE, SPECIES_MEGANIUM}},
    [SPECIES_CYNDAQUIL]             = {{EVO_ITEM, ITEM_MID_EVO_STONE, SPECIES_QUILAVA}},
    [SPECIES_QUILAVA]               = {{EVO_ITEM, ITEM_3SF_EVO_STONE, SPECIES_TYPHLOSION}},
    [SPECIES_TOTODILE]              = {{EVO_ITEM, ITEM_MID_EVO_STONE, SPECIES_CROCONAW}},
    [SPECIES_CROCONAW]              = {{EVO_ITEM, ITEM_3SF_EVO_STONE, SPECIES_FERALIGATR}},
    ...
    [SPECIES_CHINCHOU]              = {{EVO_ITEM, ITEM_2SF_EVO_STONE, SPECIES_LANTURN}},
    [SPECIES_PICHU]                 = {{EVO_FRIENDSHIP, 0, SPECIES_PIKACHU}},
    [SPECIES_CLEFFA]                = {{EVO_ITEM, ITEM_2SF_EVO_STONE, SPECIES_CLEFAIRY}},
    [SPECIES_IGGLYBUFF]             = {{EVO_FRIENDSHIP, 0, SPECIES_JIGGLYPUFF}},
    [SPECIES_TOGEPI]                = {{EVO_ITEM, ITEM_MID_EVO_STONE, SPECIES_TOGETIC}},
    [SPECIES_TOGETIC]               = {{EVO_ITEM, ITEM_3SF_EVO_STONE, SPECIES_TOGEKISS}},
    [SPECIES_NATU]                  = {{EVO_LEVEL, 25, SPECIES_XATU}},
    [SPECIES_MAREEP]                = {{EVO_ITEM, ITEM_MID_EVO_STONE, SPECIES_FLAAFFY}},
    [SPECIES_FLAAFFY]               = {{EVO_ITEM, ITEM_3SF_EVO_STONE, SPECIES_AMPHAROS}},
    [SPECIES_AMPHAROS]              = {{EVO_MEGA_EVOLUTION, ITEM_AMPHAROSITE, SPECIES_AMPHAROS_MEGA}},
    [SPECIES_MARILL]                = {{EVO_ITEM, ITEM_3SF_EVO_STONE, SPECIES_AZUMARILL}},
    ...
    [SPECIES_HOUNDOUR]              = {{EVO_ITEM, ITEM_2SF_EVO_STONE, SPECIES_HOUNDOOM}},
    [SPECIES_HOUNDOOM]              = {{EVO_MEGA_EVOLUTION, ITEM_HOUNDOOMINITE, SPECIES_HOUNDOOM_MEGA}},
    [SPECIES_PHANPY]                = {{EVO_LEVEL, 25, SPECIES_DONPHAN}},
    [SPECIES_PORYGON2]              = {{EVO_ITEM, ITEM_3SF_EVO_STONE, SPECIES_PORYGON_Z}},
    ...
    [SPECIES_TREECKO]               = {{EVO_ITEM, ITEM_MID_EVO_STONE, SPECIES_GROVYLE}},
    [SPECIES_GROVYLE]               = {{EVO_ITEM, ITEM_3SF_EVO_STONE, SPECIES_SCEPTILE}},
    [SPECIES_SCEPTILE]              = {{EVO_MEGA_EVOLUTION, ITEM_SCEPTILITE, SPECIES_SCEPTILE_MEGA}},
    [SPECIES_TORCHIC]               = {{EVO_ITEM, ITEM_MID_EVO_STONE, SPECIES_COMBUSKEN}},
    [SPECIES_COMBUSKEN]             = {{EVO_ITEM, ITEM_3SF_EVO_STONE, SPECIES_BLAZIKEN}},
    [SPECIES_BLAZIKEN]              = {{EVO_MEGA_EVOLUTION, ITEM_BLAZIKENITE, SPECIES_BLAZIKEN_MEGA}},
    [SPECIES_MUDKIP]                = {{EVO_ITEM, ITEM_MID_EVO_STONE, SPECIES_MARSHTOMP}},
    [SPECIES_MARSHTOMP]             = {{EVO_ITEM, ITEM_3SF_EVO_STONE, SPECIES_SWAMPERT}},
    [SPECIES_SWAMPERT]              = {{EVO_MEGA_EVOLUTION, ITEM_SWAMPERTITE, SPECIES_SWAMPERT_MEGA}},
    [SPECIES_POOCHYENA]             = {{EVO_ITEM, ITEM_2SF_EVO_STONE, SPECIES_MIGHTYENA}},
    ...
    [SPECIES_LOMBRE]                = {{EVO_ITEM, ITEM_3SF_EVO_STONE, SPECIES_LUDICOLO}},
    ...
    [SPECIES_BALTOY]                = {{EVO_ITEM, ITEM_2SF_EVO_STONE, SPECIES_CLAYDOL}},
    ...
    [SPECIES_SEALEO]                = {{EVO_ITEM, ITEM_3SF_EVO_STONE, SPECIES_WALREIN}},
    ...
    [SPECIES_AZURILL]               = {{EVO_ITEM, ITEM_2SF_EVO_STONE, SPECIES_MARILL}},
    ...
    [SPECIES_DUSCLOPS]              = {{EVO_ITEM, ITEM_3SF_EVO_STONE, SPECIES_DUSKNOIR}},
    ...
    [SPECIES_LOUDRED]               = {{EVO_ITEM, ITEM_3SF_EVO_STONE, SPECIES_EXPLOUD}},
    ...
    // Gens 4-7
    [SPECIES_TURTWIG]               = {{EVO_ITEM, ITEM_MID_EVO_STONE, SPECIES_GROTLE}},
    [SPECIES_GROTLE]                = {{EVO_ITEM, ITEM_3SF_EVO_STONE, SPECIES_TORTERRA}},
    [SPECIES_CHIMCHAR]              = {{EVO_ITEM, ITEM_MID_EVO_STONE, SPECIES_MONFERNO}},
    [SPECIES_MONFERNO]              = {{EVO_ITEM, ITEM_3SF_EVO_STONE, SPECIES_INFERNAPE}},
    [SPECIES_PIPLUP]                = {{EVO_ITEM, ITEM_MID_EVO_STONE, SPECIES_PRINPLUP}},
    [SPECIES_PRINPLUP]              = {{EVO_ITEM, ITEM_3SF_EVO_STONE, SPECIES_EMPOLEON}},
    [SPECIES_STARLY]                = {{EVO_ITEM, ITEM_MID_EVO_STONE, SPECIES_STARAVIA}},
    [SPECIES_STARAVIA]              = {{EVO_ITEM, ITEM_3SF_EVO_STONE, SPECIES_STARAPTOR}},
    [SPECIES_BIDOOF]                = {{EVO_LEVEL, 15, SPECIES_BIBAREL}},
    [SPECIES_KRICKETOT]             = {{EVO_LEVEL, 10, SPECIES_KRICKETUNE}},
    [SPECIES_SHINX]                 = {{EVO_ITEM, ITEM_MID_EVO_STONE, SPECIES_LUXIO}},
    [SPECIES_LUXIO]                 = {{EVO_ITEM, ITEM_3SF_EVO_STONE, SPECIES_LUXRAY}},
    ...
    [SPECIES_BUIZEL]                = {{EVO_ITEM, ITEM_2SF_EVO_STONE, SPECIES_FLOATZEL}},
    [SPECIES_CHERUBI]               = {{EVO_LEVEL, 25, SPECIES_CHERRIM}},
    [SPECIES_SHELLOS]               = {{EVO_LEVEL, 30, SPECIES_GASTRODON}},
    [SPECIES_DRIFLOON]              = {{EVO_ITEM, ITEM_2SF_EVO_STONE, SPECIES_DRIFBLIM}},
    [SPECIES_BUNEARY]               = {{EVO_ITEM, ITEM_2SF_EVO_STONE, SPECIES_LOPUNNY}},
    ...
    [SPECIES_STUNKY]                = {{EVO_ITEM, ITEM_2SF_EVO_STONE, SPECIES_SKUNTANK}},
    ...
    [SPECIES_CROAGUNK]              = {{EVO_ITEM, ITEM_2SF_EVO_STONE, SPECIES_TOXICROAK}},
    [SPECIES_FINNEON]               = {{EVO_LEVEL, 31, SPECIES_LUMINEON}},
    [SPECIES_MANTYKE]               = {{EVO_ITEM, ITEM_2SF_EVO_STONE, SPECIES_MANTINE}},
    ...
    [SPECIES_SNIVY]                 = {{EVO_ITEM, ITEM_MID_EVO_STONE, SPECIES_SERVINE}},
    [SPECIES_SERVINE]               = {{EVO_ITEM, ITEM_3SF_EVO_STONE, SPECIES_SERPERIOR}},
    [SPECIES_TEPIG]                 = {{EVO_ITEM, ITEM_MID_EVO_STONE, SPECIES_PIGNITE}},
    [SPECIES_PIGNITE]               = {{EVO_ITEM, ITEM_3SF_EVO_STONE, SPECIES_EMBOAR}},
    [SPECIES_OSHAWOTT]              = {{EVO_ITEM, ITEM_MID_EVO_STONE, SPECIES_DEWOTT}},
    [SPECIES_DEWOTT]                = {{EVO_ITEM, ITEM_3SF_EVO_STONE, SPECIES_SAMUROTT}},
    ...
    [SPECIES_SCRAGGY]               = {{EVO_ITEM, ITEM_2SF_EVO_STONE, SPECIES_SCRAFTY}},
    [SPECIES_YAMASK]                = {{EVO_ITEM, ITEM_2SF_EVO_STONE, SPECIES_COFAGRIGUS}},
    ...
    [SPECIES_VANILLITE]             = {{EVO_ITEM, ITEM_MID_EVO_STONE, SPECIES_VANILLISH}},
    [SPECIES_VANILLISH]             = {{EVO_ITEM, ITEM_3SF_EVO_STONE, SPECIES_VANILLUXE}},
    ...
    [SPECIES_FOONGUS]               = {{EVO_ITEM, ITEM_2SF_EVO_STONE, SPECIES_AMOONGUSS}},
    [SPECIES_FRILLISH]              = {{EVO_ITEM, ITEM_2SF_EVO_STONE, SPECIES_JELLICENT}},
    ...
    [SPECIES_CHESPIN]               = {{EVO_ITEM, ITEM_MID_EVO_STONE, SPECIES_QUILLADIN}},
    [SPECIES_QUILLADIN]             = {{EVO_ITEM, ITEM_3SF_EVO_STONE, SPECIES_CHESNAUGHT}},
    [SPECIES_FENNEKIN]              = {{EVO_ITEM, ITEM_MID_EVO_STONE, SPECIES_BRAIXEN}},
    [SPECIES_BRAIXEN]               = {{EVO_ITEM, ITEM_3SF_EVO_STONE, SPECIES_DELPHOX}},
    [SPECIES_FROAKIE]               = {{EVO_ITEM, ITEM_MID_EVO_STONE, SPECIES_FROGADIER}},
    [SPECIES_FROGADIER]             = {{EVO_ITEM, ITEM_3SF_EVO_STONE, SPECIES_GRENINJA}},
    ...
    [SPECIES_FLABEBE]               = {{EVO_ITEM, ITEM_MID_EVO_STONE, SPECIES_FLOETTE}},
    [SPECIES_FLOETTE]               = {{EVO_ITEM, ITEM_3SF_EVO_STONE, SPECIES_FLORGES}},
    ...
    [SPECIES_BERGMITE]              = {{EVO_ITEM, ITEM_2SF_EVO_STONE, SPECIES_AVALUGG}},
    [SPECIES_NOIBAT]                = {{EVO_LEVEL, 48, SPECIES_NOIVERN}},
    [SPECIES_DIANCIE]               = {{EVO_MEGA_EVOLUTION, ITEM_DIANCITE, SPECIES_DIANCIE_MEGA}},
    [SPECIES_ROWLET]                = {{EVO_ITEM, ITEM_MID_EVO_STONE, SPECIES_DARTRIX}},
    [SPECIES_DARTRIX]               = {{EVO_ITEM, ITEM_3SF_EVO_STONE, SPECIES_DECIDUEYE}},
    [SPECIES_LITTEN]                = {{EVO_ITEM, ITEM_MID_EVO_STONE, SPECIES_TORRACAT}},
    [SPECIES_TORRACAT]              = {{EVO_ITEM, ITEM_3SF_EVO_STONE, SPECIES_INCINEROAR}},
    [SPECIES_POPPLIO]               = {{EVO_ITEM, ITEM_MID_EVO_STONE, SPECIES_BRIONNE}},
    [SPECIES_BRIONNE]               = {{EVO_ITEM, ITEM_3SF_EVO_STONE, SPECIES_PRIMARINA}},
    ...
    [SPECIES_SALANDIT]              = {{EVO_ITEM, ITEM_2SF_EVO_STONE, SPECIES_SALAZZLE}},
    ...
    [SPECIES_GROOKEY]               = {{EVO_ITEM, ITEM_MID_EVO_STONE, SPECIES_THWACKEY}},
    [SPECIES_THWACKEY]              = {{EVO_ITEM, ITEM_3SF_EVO_STONE, SPECIES_RILLABOOM}},
    [SPECIES_SCORBUNNY]             = {{EVO_ITEM, ITEM_MID_EVO_STONE, SPECIES_RABOOT}},
    [SPECIES_RABOOT]                = {{EVO_ITEM, ITEM_3SF_EVO_STONE, SPECIES_CINDERACE}},
    [SPECIES_SOBBLE]                = {{EVO_ITEM, ITEM_MID_EVO_STONE, SPECIES_DRIZZILE}},
    [SPECIES_DRIZZILE]              = {{EVO_ITEM, ITEM_3SF_EVO_STONE, SPECIES_INTELEON}},
    ...
    [SPECIES_ROLYCOLY]              = {{EVO_ITEM, ITEM_MID_EVO_STONE, SPECIES_CARKOL}},
    [SPECIES_CARKOL]                = {{EVO_ITEM, ITEM_3SF_EVO_STONE, SPECIES_COALOSSAL}},
    ...
    [SPECIES_HATTREM]               = {{EVO_ITEM, ITEM_3SF_EVO_STONE, SPECIES_HATTERENE}},
    [SPECIES_IMPIDIMP]              = {{EVO_ITEM, ITEM_MID_EVO_STONE, SPECIES_MORGREM}},
    [SPECIES_MORGREM]               = {{EVO_ITEM, ITEM_3SF_EVO_STONE, SPECIES_GRIMMSNARL}},
    ...
    [SPECIES_VULPIX_ALOLAN]         = {{EVO_ITEM, ITEM_2SF_EVO_STONE, SPECIES_NINETALES_ALOLAN}},
    ...
    [SPECIES_GRAVELER_ALOLAN]       = {{EVO_ITEM, ITEM_3SF_EVO_STONE, SPECIES_GOLEM_ALOLAN}},
    ...
    [SPECIES_LINOONE_GALARIAN]      = {{EVO_ITEM, ITEM_3SF_EVO_STONE, SPECIES_OBSTAGOON}},
