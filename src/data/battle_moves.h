const struct BattleMove gBattleMoves[MOVES_COUNT] =
{
    ...
    [MOVE_AURORA_BEAM] =
    {
        ...
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .flags = FLAG_HIGH_CRIT | FLAG_PROTECT_AFFECTED | FLAG_MIRROR_MOVE_AFFECTED | FLAG_SHEER_FORCE_BOOST,
        .split = SPLIT_SPECIAL,
    },
    ...
    [MOVE_FLAME_WHEEL] =
    {
        ...
        .target = MOVE_TARGET_SELECTED,
        .priority = 0,
        .flags = FLAG_HIGH_CRIT | FLAG_MAKES_CONTACT | FLAG_PROTECT_AFFECTED | FLAG_MIRROR_MOVE_AFFECTED | FLAG_SHEER_FORCE_BOOST | FLAG_THAW_USER,
        .split = SPLIT_PHYSICAL,
    },
