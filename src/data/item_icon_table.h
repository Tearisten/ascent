const u32 *const gItemIconTable[][2] =
{
    ...
    [ITEM_THERMOSTAT] = {gItemIcon_Thermometer, gItemIconPalette_Thermometer}, 
    ...
    [ITEM_2SF_EVO_STONE] = {gItemIcon_DuskStone, gItemIconPalette_DuskStone}, // Todo, dusk stone for now
    [ITEM_3SF_EVO_STONE] = {gItemIcon_SunStone, gItemIconPalette_SunStone}, // Todo, sun stone for now
